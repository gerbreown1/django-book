...
\title{Tango with Django}
\subtitle{Create desktop and web applications with Django.}
...
\include{generated_polytex/requirements}
\include{generated_polytex/application_requirements}
\include{generated_polytex/bibliography}
\end{document}
